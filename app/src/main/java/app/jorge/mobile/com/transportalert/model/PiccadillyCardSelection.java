...
public class PiccadillyCardSelection implements CardSelection {



    @Override
    public int getIdKeyProperty() {
        return R.string.piccadilly_label;
    }

    @Override
    public int getIdTxtLabel() {
        return R.id.txtPiccadilly;
    }

    @Override
    public int getCheckedColourCard() {
        return R.string.piccadilly_colour;
    }
