...
public class HammersmithCardSelection implements CardSelection {



    @Override
    public int getIdKeyProperty() {
        return R.string.hammersmith_label;
    }

    @Override
    public int getIdTxtLabel() {
        return R.id.txtHammersmmith;
    }

    @Override
    public int getCheckedColourCard() {
        return R.string.hammersmith_colour;
    }

    @Override
    public int getCkechedCoulourText() {
        return R.string.hammersmith_colour_second;
    }
