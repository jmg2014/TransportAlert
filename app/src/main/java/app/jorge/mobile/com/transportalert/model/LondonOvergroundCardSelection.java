...
public class LondonOvergroundCardSelection implements CardSelection {



    @Override
    public int getIdKeyProperty() {
        return R.string.london_overground_label;
    }

    @Override
    public int getIdTxtLabel() {
        return R.id.txtOvergroud;
    }

    @Override
    public int getCheckedColourCard() {
        return R.string.london_overground_colour;
    }
