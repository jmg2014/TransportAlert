...
public class CircleCardSelection implements CardSelection {



    @Override
    public int getIdKeyProperty() {
        return R.string.circle_label;
    }

    @Override
    public int getIdTxtLabel() {
        return R.id.txtCircle;
    }

    @Override
    public int getCheckedColourCard() {
        return R.string.circle_colour;
    }

    @Override
    public int getCkechedCoulourText() {
        return R.string.circle_colour_second;
    }
