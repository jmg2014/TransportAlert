...
public class MetropolitanCardSelection implements CardSelection {



    @Override
    public int getIdKeyProperty() {
        return R.string.metropolitan_label;
    }

    @Override
    public int getIdTxtLabel() {
        return R.id.txtMetropolitan;
    }

    @Override
    public int getCheckedColourCard() {
        return R.string.metropolitan_colour;
    }
